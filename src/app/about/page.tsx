...
export const metadata = { title: "About — Stevie" };
          ...
          <div className="mx-auto max-w-[740px]">
            ...
            <div className="mb-12">
              ...
              <h1 className="mt-[18px] text-[clamp(36px,4vw,56px)] leading-[1.04] tracking-[-0.02em] text-cobalt-ink">
                {aboutContent.title}{" "}
                <em className="italic text-cobalt">{aboutContent.titleEmphasis}</em>
              </h1>
              <p className="mt-4 max-w-[52ch] text-[17px] leading-[1.6] text-ink-soft">
                {aboutContent.lede}
              </p>
            </div>
